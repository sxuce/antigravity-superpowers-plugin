...
```bash
# Example: Batch 1 has 3 independent steps. Use the spawn_subagent.py script located under the plugin's skills/workflow/scripts/ directory (e.g. ~/.gemini/antigravity-cli/plugins/superpowers/skills/workflow/scripts/spawn_subagent.py) or .agent/skills/workflow/scripts/:
...
- Verify skill exists: `skills/{skill}/SKILL.md` (or `.agent/skills/...`)
